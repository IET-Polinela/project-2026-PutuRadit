 ...
 *
 * Menggunakan wildcard 'wildcard-api-path', fungsi ini akan mencegat request ke domain apapun
...
async function mockSPAApiUrl(page) {
    ...
    // Gunakan wildcard wildcard-api-path untuk menangkap dari host/domain mana saja
    await page.route('wildcard-api-path', async (route) => {
